...
public class RedisUtils {
    ...
    public boolean expire(String key,long time){
        try {
            ...
            System.out.println("RedisUtil指定缓存失效时间报错，报错信息：" + e);
            return false;
        }
    }
    ...
    public boolean hasKey(String key){
        try {
            ...
            System.out.println("RedisUtil判断key是否存在报错，报错信息：" + e);
            return false;
        }
    }
    ...
    public boolean set(String key,Object value) {
        try {
            ...
            System.out.println("RedisUtil普通缓存放入报错，报错信息：" + e);
            return false;
        }
    }
    ...
    public boolean set(String key,Object value,long time){
        try {
            ...
            System.out.println("RedisUtil普通缓存放入并设置时间报错，报错信息：" + e);
            return false;
        }
    }
    ...
    public boolean hmset(String key, Map<String,Object> map){
        try {
            ...
            System.out.println("RedisUtil报错，报错信息：" + e);
            return false;
        }
    }
