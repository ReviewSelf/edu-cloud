...
public class ExamAttendLogController {
    ...
    @GetMapping("addAttendLogFromAbilityExam")
    @Operation(summary = "等级考试报名")
    public Result<String> addAttendLogFromAbilityExam(@RequestParam("examId") Long examId, @RequestParam("abilityId") Long abilityId) {
       return examAttendLogService.addAttendLogFromAbilityExam(examId,abilityId);
    }
