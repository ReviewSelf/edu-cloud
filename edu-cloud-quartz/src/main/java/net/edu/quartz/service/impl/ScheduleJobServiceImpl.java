...
import net.edu.quartz.convert.ScheduleJobConvert;
import net.edu.quartz.dao.ScheduleJobDao;
import net.edu.quartz.entity.ScheduleJobEntity;
import net.edu.quartz.enums.ScheduleStatusEnum;
import net.edu.quartz.query.ScheduleJobQuery;
import net.edu.quartz.service.ScheduleJobService;
import net.edu.quartz.utils.ScheduleUtils;
...
public class ScheduleJobServiceImpl extends BaseServiceImpl<ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
    ...
    public void run(ScheduleJobVO vo) {
        ScheduleJobEntity scheduleJob = baseMapper.selectById(vo.getId());
